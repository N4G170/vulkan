...
layout(location = 5) in vec3 in_specular_colour;
...
layout(location = 3) out vec3 out_specular_colour;
layout(location = 4) out vec3 out_view_direction;

layout(location = 5) out vec4 out_light_direction;
layout(location = 6) out float out_diffuse_intensity;
layout(location = 7) out vec4 out_light_colour;
layout(location = 8) out float out_ambient_intensity;
layout(location = 9) out float out_specular_intensity;
...
void main()
{
    ...
    out_specular_intensity = ubo.specular_intensity;
    ...
    out_specular_colour = in_specular_colour;

    //view direction
    out_view_direction = ubo.camera_direction.xyz;
}
